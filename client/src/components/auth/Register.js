                            ...
                            <form noValidate onSubmit={this.onSubmit}>
                                ...
                                <div className="form-group">
                                    ...
                                    <input type="email"
                                        ...
                                        className={classnames("form-control form-control-lg", { 'is-invalid': errors.email })} placeholder="Email Address" name="email" value={this.state.email} onChange={this.onChange} />
